export default {
  ...
  about: {
    ...
    achievements: [
      ...
      {
        year: '2018',
        title: 'Sesiones de Grabación en Detroit',
        description: 'Grabó 11 composiciones originales producidas por el reconocido trompetista Walter White, con la participación de músicos de jazz de clase mundial como Jeff Trudell (batería) y Jack Dryden (contrabajo y bajo eléctrico).'
      },
      {
        year: '2001',
        title: 'Fundación de Barajas Producciones',
      ...
      {
        year: '1980s',
        title: 'Ars Nova Jazz Fusion',
        description: 'Fundador y director del aclamado grupo Ars Nova Jazz Fusion. Presentaciones destacadas en el Festival Internacional Cervantino, el Festival Internacional de Jazz de la Ciudad de México (1990) y eventos en Estados Unidos.'
      }
    ]
  },
  songs: {
