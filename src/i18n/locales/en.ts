...
export default {
  ...
  about: {
    ...
    achievements: [
      ...
      {
        year: '2018',
        title: 'Detroit Recording Sessions',
        description: 'Recorded 11 original compositions produced by renowned trumpeter Walter White, featuring world-class jazz musicians Jeff Trudell (drums) and Jack Dryden (double bass and electric bass).'
      },
      {
        year: '2001',
        title: 'Foundation of Barajas Productions',
      ...
      },
      {
        ...
        description: 'Founder and director of the acclaimed group Ars Nova Jazz Fusion. Notable performances at the International Cervantino Festival, Mexico City International Jazz Festival (1990), and events in the United States.'
      }
    ]
  },
  songs: {
